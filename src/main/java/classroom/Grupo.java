...
public class Grupo {
    ...
    public Grupo(int cantidadEstudiantes, Persona profesor, Asignatura asignatura, int codigo, String horario) {
        this(cantidadEstudiantes,profesor, asignatura, codigo);
    }

    public Grupo(int cantidadEstudiantes, Persona profesor, Asignatura asignatura,int codigo) {
    	Persona[] estudiantes = new Persona[cantidadEstudiantes];
    	this.estudiantes = estudiantes;
        this.profesor = profesor;
        this.asignatura = asignatura;
        this.codigo=codigo;
